...
type Resource struct {
	...
	Holidays []gplan.Holidays `json:"hollidays"`
...
func NewResource(id gplan.ResourceID, description string, resourceType string, availableFrom time.Time, holidays []gplan.Holidays) *Resource {
	return &Resource{
		ID:                id,
